...
<?php else :
	...
	if( isset($responsive) && !empty($responsive) ) {
		$screen_desktop 			= $responsive['screen_desktop'];
		$screen_desktopsmall 		= $responsive['screen_desktopsmall'];
		$screen_tablet 				= $responsive['screen_tablet'];
		$screen_landscape_mobile 	= $responsive['screen_landscape_mobile'];
		$screen_mobile 				= $responsive['screen_mobile'];
	}
